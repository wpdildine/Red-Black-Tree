...
var Node = /** @class */ (function () {
    ...
    Node.prototype.nodeColor = function (node) {
        return node.color;
    };
    return Node;
}());
var Tree = /** @class */ (function () {
    ...
    Tree.prototype.nodeColor = function (node) {
...
var Balancer = /** @class */ (function () {
    function Balancer(tree) {
        this.deleteCase1 = function (node) {
            if (node.parent !== null)
                this.deleteCase2(node);
        };
        this.deleteCase4 = function (node) {
        ...
        this.deleteCase6 = function (node) {
            var sibling = node.getSibling();
    ...
    Balancer.prototype.nodeColor = function (node) {
        return node.color === null ? Color.black : node.color;
    };
    return Balancer;
}());
